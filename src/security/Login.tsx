    ...
    <div className="hero min-h-screen">
      <div className="hero-content flex-col lg:flex-row-reverse">
        <div className="text-center lg:text-left">
          ...
          <p className="py-6">
            This is for employees only, Please dont try to login in, or i will
            lose it
          </p>
        </div>
        <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
          <form
            className="card-body bg-custom-txt-colour rounded-xl"
          ...
          >
            ...
            <div className="form-control mt-6 ">
              <button
                type="submit"
                className="btn bg-custom-btn-colour text-custom-txt-colour"
              >
                Login
              </button>
            </div>
